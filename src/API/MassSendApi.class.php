...
*/
     ...
     * @return int     msg_id     发送出去的消息ID
     */
    public function openidMpnews($media_id = '', $openids = array())
    {
        $queryStr = array();
     ...
     * @return int     msg_id     发送出去的消息ID
     */
    public function openidText($content = '', $openids = array())
    {
        $queryStr = array();
        $queryStr['filter'] = $openids;
        $queryStr['text']['content']     = $content;
     ...
     * @return int     msg_id     发送出去的消息ID
     */
    public function openidVoice($media_id = '', $openids = array())
    {
        $queryStr = array();
        $queryStr['filter'] = $openids;
        $queryStr['voice']['media_id']   = $media_id;
     ...
     * @return int     msg_id     发送出去的消息ID
     */
    public function openidImage($media_id = '', $openids = array())
    {
        $queryStr = array();
        $queryStr['filter'] = $openids;
        $queryStr['image']['media_id']   = $media_id;
     ...
     * @return int     msg_id     发送出去的消息ID
     */
    public function openidVideo($media_id = '', $openids = array(), $title = '', $description = '')
    {
        $queryStr = array();
        $queryStr['filter'] = $openids;
     ...
     * @return int     msg_id     发送出去的消息ID
     */
    public function openidWxcard($card_id = '', $openids = array())
    {
        $queryStr = array();
        $queryStr['filter'] = $openids;
        $queryStr['wxcard']['card_id']   = $card_id;
